...
/**
 * @ORM\Entity(repositoryClass="App\Repository\IsolantGammeRepository")
 */
class IsolantGamme
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Gamme", mappedBy="isolant")
     */
    private $gammes;
    ...
    public function removeGamme(Gamme $gamme): self
    {
        if ($this->gammes->contains($gamme)) {
            ...
            if ($gamme->getIsolant() === $this) {
                $gamme->setIsolant(null);
            }
        }
